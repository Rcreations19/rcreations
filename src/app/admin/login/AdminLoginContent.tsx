                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-4 bg-neutral-50 border border-neutral-200 rounded-xl text-2xl text-center font-bold focus:bg-white focus:border-[#2aabb0] focus:ring-4 focus:ring-[#2aabb0]/10 focus:outline-none transition-all"
                      placeholder="------"
                    />
                  </div>
