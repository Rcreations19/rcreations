...
import { ArrowLeft, User, MapPin, CreditCard, Package, Truck, Clock } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-[#eaeaea] rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-[#eaeaea] bg-[#fcfcfc] flex items-center gap-2">
              ...
              {order.items.map((item: any) => (
                <div key={item.id} className="p-4 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#595959] mt-1 font-mono">ID: {item.product_id}</p>
                  </div>
            ...
            <div className="p-4 bg-[#fcfcfc] border-t border-[#eaeaea]">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between text-base font-bold text-[#111111] pt-2 border-t border-[#eaeaea]">
                  <span>Total</span>
        ...
        <div className="space-y-6">
          ...
          {/* Status Update Card */}
          <div className="bg-white border border-[#eaeaea] rounded-xl shadow-sm overflow-hidden p-5">
            ...
            <form action={handleStatusUpdate} className="space-y-4">
              <div>
                <select 
                  ...
                  className="w-full p-2.5 bg-[#fcfcfc] border border-[#eaeaea] rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#0070f3] outline-none"
                >
